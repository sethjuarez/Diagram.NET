...
namespace Dalssoft.DiagramNet
{
	public class Designer : System.Windows.Forms.UserControl
	{
		...
		private void RecreateEventsHandlers()
		{
			...
			document.AppearancePropertyChanged += document_AppearancePropertyChanged;
			document.ElementPropertyChanged += document_ElementPropertyChanged;
			document.ElementSelection += document_ElementSelection;
		}
	}
}
